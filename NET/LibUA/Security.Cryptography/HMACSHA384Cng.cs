...
namespace LibUA.Security.Cryptography
{
    ...
    ///     </para>
    ///     <para>
    ///         Since most of the HMACSHA384Cng APIs are inherited from the <see cref="HMAC" /> base class,
    ...
    public sealed class HMACSHA384Cng : HMAC, ICngAlgorithm
    {
        ...
        public HMACSHA384Cng(byte[] key, CngProvider algorithmProvider)
        {
            ...
            m_hmac = new BCryptHMAC(CngAlgorithm.Sha384, algorithmProvider, "SHA384", BlockSize, key);
